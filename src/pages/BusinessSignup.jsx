  ...
  return (
    <div className="min-h-screen pb-20" style={{ background: "linear-gradient(160deg, #B8D8D8 0%, #C8D8E8 40%, #D0D8E8 70%, #C8D0E0 100%)" }}>
      ...
      <main className="max-w-lg mx-auto px-5 py-8 space-y-6">
        {/* Selected Plan Badge */}
        <div className="flex items-center justify-between rounded-2xl px-5 py-4" style={{ background: "linear-gradient(135deg, #64c39f 0%, #1a2f42 100%)", boxShadow: "0 4px 20px rgba(99,196,159,0.3)" }}>
          <div>
