  ...
  return (
    <div className="min-h-screen pb-20 relative overflow-hidden">
      ...
      <div className="fixed inset-0 -z-10" style={{
        ...
        {theme === 'dark' ? (
          <>
            <div className="absolute inset-0 animate-lava-lamp-1 blur-3xl" />
            <div className="absolute inset-0 animate-lava-lamp-2 blur-3xl" />
            <div className="absolute inset-0 animate-lava-lamp-3 blur-3xl" />
          </>
        ) : (
          <>
            <div className="absolute inset-0 animate-lava-lamp-1 blur-3xl" />
