  ...
  return (
    <div className="min-h-screen pb-20 relative overflow-hidden">
      ...
      <div className="fixed inset-0 -z-10" style={{
        ...
        {theme === 'dark' ? (
          <>
            <div className="absolute inset-0 bg-gradient-to-b from-green-100 via-green-300 via-blue-400 via-pink-100 to-cyan-300 animate-gradient-shift blur-3xl" />
            <div className="absolute inset-0 bg-gradient-to-tr from-green-300 via-pink-100 via-blue-300 via-pink-200 to-blue-300 animate-gradient-shift-slow blur-3xl" />
            <div className="absolute inset-0 bg-gradient-to-bl from-cyan-200 via-pink-100 via-green-300 via-blue-300 to-green-300 animate-gradient-shift-reverse blur-3xl" />
          </>
        ) : (
          <>
            <div className="absolute inset-0 bg-gradient-to-b from-green-100 via-green-300 via-blue-400 via-pink-100 to-cyan-300 animate-gradient-shift blur-3xl" />
