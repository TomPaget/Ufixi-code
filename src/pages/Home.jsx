...
// Loader2 still used in payment dialog
             ...
             >
              <div className="flex flex-col items-center gap-4 py-6">
                      <RippleButton
                          ...
                          <p className="text-sm font-medium mt-2" style={{ color: '#6B6A8E' }}>{needsPayment ? 'Pay £0.99 to scan a new issue' : 'Tap to scan a new issue'}</p>
                    </div>
              </div>
            )}
                    </AnimatePresence>
