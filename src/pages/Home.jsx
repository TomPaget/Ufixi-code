  ...
  return (
    <div className="min-h-screen pb-20 relative overflow-hidden">
      ...
      <div className="fixed inset-0 -z-10" style={{
        ...
        {theme === 'dark' ? (
          <>
            <div className="absolute inset-0 bg-gradient-to-b from-blue-300 via-cyan-200 via-emerald-600 via-orange-400 to-orange-300 animate-gradient-shift blur-3xl" />
            <div className="absolute inset-0 bg-gradient-to-tr from-orange-400 via-orange-300 via-pink-200 via-blue-200 to-cyan-200 animate-gradient-shift-slow blur-3xl" />
            <div className="absolute inset-0 bg-gradient-to-bl from-blue-200 via-emerald-500 via-orange-300 to-pink-300 animate-gradient-shift-reverse blur-3xl" />
          </>
        ) : (
          <>
            <div className="absolute inset-0 bg-gradient-to-b from-blue-300 via-cyan-200 via-emerald-600 via-orange-400 to-orange-300 animate-gradient-shift blur-3xl" />
