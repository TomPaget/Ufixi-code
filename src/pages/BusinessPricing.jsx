...
export default function BusinessPricing() {
  ...
  return (
    <div className="min-h-screen pb-20 bg-slate-50">
      {/* Header */}
      <header className="sticky top-0 z-30 border-b bg-white border-slate-200">
      ...
      <main className="max-w-6xl mx-auto px-5 py-12 space-y-16">
          ...
          {plans.map((plan) => {
            ...
            return (
              <div
                key={plan.name}
                className={cn(
                  "relative rounded-2xl border-2 p-6 transition-all cursor-pointer bg-white",
                  isSelected
        ...
        {selectedPlan && (
          <div className="max-w-2xl mx-auto rounded-2xl border p-8 bg-white border-slate-200">
        ...
        {/* Social Proof */}
        <div className="text-center p-8 rounded-2xl border bg-white border-slate-200">
