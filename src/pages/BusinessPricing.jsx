...
export default function BusinessPricing() {
  ...
  return (
    <div className={cn(
      "min-h-screen pb-20",
      theme === "dark" ? "bg-gradient-to-br from-[#0a1929] via-[#0f2942] to-[#1a3a52]" : "bg-slate-50"
    )}>
      {/* Header */}
      <header className={cn(
          ...
          {plans.map((plan) => {
            ...
            return (
              <div
                ...
                <div className="bg-slate-800 text-slate-800 mb-4 rounded-xl w-12 h-12 flex items-center justify-center from-slate-900 to-slate-950">
